		...
		if($mode == "tambah"){
			// insert tabel_event
				...
				$data_tabel_event = [
					...
					"alamat_event" => htmlspecialchars($this->input->post('alamat_event', true)),
					"latitude" => htmlspecialchars($this->input->post('alamat-event-latitude', true)),
					"longitude" => htmlspecialchars($this->input->post('alamat-event-longitude', true)),
